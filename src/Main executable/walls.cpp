			...
			if (WCL->Visible)
			{
				...
				if (xx > -128 && xx < Lx + 128, yy - dz > -128 - dz && yy - dz < Ly + 128 - dz)
				{
					...
					if (WCL->Sprite >= 32)
					{
						if (WCL->Sprite < 64)
						{
							AddOptPoint(ZBF_LO, 0, 0, xx - WCR->GateDx + 32, yy - WCR->GateDy - dz + 16, NULL, WCR->GateFile,
							            WCL->Sprite - 32, AV_TRANSPARENT | AV_SHADOWONLY);
							switch (WCL->Sprite)
							{
							case 32:
								AddOptPoint(ZBF_NORMAL, xx + 32, yy + 16, xx - WCR->GateDx + 32, yy - WCR->GateDy - dz + 16, NULL,
								            WCR->GateFile, WCL->Sprite - 32, AV_TRANSPARENT | AV_WITHOUTSHADOW);
								break;
							case 33:
								AddOptLine(xx + 96, yy - 48, xx - 32, yy + 48, xx - WCR->GateDx + 32, yy - WCR->GateDy - dz + 16, NULL,
								           WCR->GateFile, WCL->Sprite - 32, AV_TRANSPARENT | AV_WITHOUTSHADOW);
								break;
							case 34:
								AddOptPoint(ZBF_NORMAL, xx + 32, yy + 16, xx - WCR->GateDx + 32, yy - WCR->GateDy - dz + 16, NULL,
								...
								break;
							case 35:
								AddOptLine(xx - 32, yy - 16, xx + 96, yy + 48, xx - WCR->GateDx + 32, yy - WCR->GateDy - dz + 16, NULL,
								           WCR->GateFile, WCL->Sprite - 32, AV_TRANSPARENT | AV_WITHOUTSHADOW);
								break;
							};
						};
					...
					{
						AddOptPoint(ZBF_LO, 0, 0, xx - WCR->dx, yy - WCR->dy - dz, NULL, WCR->RIndex, WCL->SprBase + WCL->Sprite,
						            AV_SHADOWONLY);
						AddOptPoint(ZBF_NORMAL, xx + 32, yy + 16, xx - WCR->dx, yy - WCR->dy - dz, NULL, WCR->RIndex,
				...
				if (xx > -128 && xx < Lx + 128 && yy - dz > -128 && yy - dz < Ly + 128)
				{
					if (CUR)
					{
						...
						if (WCL->Sprite >= 32)
						{
							...
							{
								AddOptPoint(ZBF_LO, 0, 0, xx - WCR->GateDx + 32, yy - WCR->GateDy - dz + 16, NULL, WCR->GateFile,
								            WCL->Sprite - 32, AV_SHADOWONLY);
								RegisterVisibleGP(CUR->Index, WCR->GateFile, WCL->Sprite - 32, xx - WCR->GateDx + 32,
								                  yy - WCR->GateDy - dz + 16);
								...
								case 32:
									if (IsSel)
									{
										AddOptPoint(ZBF_NORMAL, xx + 32, yy + 48, xx - WCR->GateDx + 32, yy - WCR->GateDy - dz + 16, CUR,
										            WCR->GateFile, WCL->Sprite - 32, AV_PULSING | AV_DARK | AV_WITHOUTSHADOW);
									...
									AddOptPoint(ZBF_LO, 0, 0, xx - WCR->GateDx + 32, yy - WCR->GateDy - dz + 16, CUR, WCR->GateFile, gs,
									            AV_SHADOWONLY);
									break;
								case 33:
									if (IsSel)AddOptLine(xx + 95, yy - 15 + 14, xx - 31, yy + 47 + 14, xx - WCR->GateDx + 32,
									                     yy - WCR->GateDy - dz + 16, CUR, WCR->GateFile, WCL->Sprite - 32,
									                     AV_PULSING | AV_DARK | AV_WITHOUTSHADOW);
									else AddOptLine(xx + 95, yy - 15 + 14, xx - 31, yy + 47 + 14, xx - WCR->GateDx + 32,
									                yy - WCR->GateDy - dz + 16, CUR, WCR->GateFile, WCL->Sprite - 32, AV_WITHOUTSHADOW);
									//RegisterVisibleGP(CUR->Index,WCR->GateFile,WCL->Sprite-32,xx-31,yy+47+14);
									AddOptLine(xx + 95, yy - 15 - 14, xx - 31, yy + 47 - 14, xx - WCR->GateDx + 32, yy - WCR->GateDy - dz + 16,
									           CUR, WCR->GateFile, gs, AV_WITHOUTSHADOW);
									//RegisterVisibleGP(CUR->Index,WCR->GateFile,gs,xx-WCR->GateDx+32,yy-WCR->GateDy-dz+16);
									AddOptPoint(ZBF_LO, 0, 0, xx - WCR->GateDx + 32, yy - WCR->GateDy - dz + 16, CUR, WCR->GateFile, gs,
									            AV_SHADOWONLY);
									break;
								case 34:
									if (IsSel)AddOptPoint(ZBF_NORMAL, xx + 32, yy + 16 + 12, xx - WCR->GateDx + 32, yy - WCR->GateDy - dz + 16,
									                      CUR, WCR->GateFile, WCL->Sprite - 32, AV_PULSING | AV_DARK | AV_WITHOUTSHADOW);
									else AddOptPoint(ZBF_NORMAL, xx + 32, yy + 16 + 12, xx - WCR->GateDx + 32, yy - WCR->GateDy - dz + 16, CUR,
									                 WCR->GateFile, WCL->Sprite - 32, AV_WITHOUTSHADOW);
									AddOptPoint(ZBF_NORMAL, xx + 32, yy + 16 - 12, xx - WCR->GateDx + 32, yy - WCR->GateDy - dz + 16, CUR,
									            WCR->GateFile, gs, AV_WITHOUTSHADOW);
									AddOptPoint(ZBF_LO, 0, 0, xx - WCR->GateDx + 32, yy - WCR->GateDy - dz + 16, CUR, WCR->GateFile, gs,
									            AV_SHADOWONLY);
									break;
								case 35:
									if (IsSel)AddOptLine(xx - 31, yy - 15 + 12, xx + 95, yy + 47 + 12, xx - WCR->GateDx + 32,
									                     yy - WCR->GateDy - dz + 16, CUR, WCR->GateFile, WCL->Sprite - 32,
									                     AV_PULSING | AV_DARK | AV_WITHOUTSHADOW);
									else AddOptLine(xx - 32, yy - 15 + 12, xx + 95, yy + 47 + 12, xx - WCR->GateDx + 32,
									                yy - WCR->GateDy - dz + 16, CUR, WCR->GateFile, WCL->Sprite - 32, AV_WITHOUTSHADOW);
									AddOptLine(xx - 32, yy - 15 - 12, xx + 95, yy + 47 - 12, xx - WCR->GateDx + 32, yy - WCR->GateDy - dz + 16,
									           CUR, WCR->GateFile, gs, AV_WITHOUTSHADOW);
									AddOptPoint(ZBF_LO, 0, 0, xx - WCR->GateDx + 32, yy - WCR->GateDy - dz + 16, CUR, WCR->GateFile, gs,
									            AV_SHADOWONLY);
									break;
						...
						{
							AddOptPoint(ZBF_LO, 0, 0, xx - WCR->dx, yy - WCR->dy - dz, CUR, WCR->RIndex, WCL->SprBase + WCL->Sprite,
							            AV_SHADOWONLY);
							if (IsSel)AddOptPoint(ZBF_NORMAL, xx + 32, yy + 16, xx - WCR->dx, yy - WCR->dy - dz, CUR, WCR->RIndex,
							                      WCL->SprBase + WCL->Sprite, AV_PULSING | AV_DARK | AV_WITHOUTSHADOW);
							else AddOptPoint(ZBF_NORMAL, xx + 32, yy + 16, xx - WCR->dx, yy - WCR->dy - dz, CUR, WCR->RIndex,
	...
	for (int i = 0; i < NCells; i++)
	{
		...
		if (Cells[i].Visible)
		{
			...
			if (xx > -128 && xx < Lx + 128, yy - dz > -128 && yy - dz < Ly + 128)
			{
				...
				{
					AddOptPoint(ZBF_NORMAL, xx, yy + 320, xx - WCR->dx, yy - WCR->dy - dz, NULL, WCR->RIndex, WCL->Sprite,
					            AV_PULSING | AV_WHITE | AV_WITHOUTSHADOW);
				}
				else
				{
					AddOptPoint(ZBF_NORMAL, xx, yy + 320, xx - WCR->dx, yy - WCR->dy - dz, NULL, WCR->RIndex, WCL->Sprite,
					            AV_PULSING | AV_RED | AV_WITHOUTSHADOW);
				}
			}
		}
	}
...
int GetTopDistanceW(int xa, int ya, int xb, int yb)
{
	if (xa < 0 || ya < 0 || xb < 0 || yb < 0 ||
		xa >= TopLx || xb >= TopLx || ya >= TopLx || yb >= TopLx)
		return 0xFFFF;
