...
__declspec( dllexport ) void StartExplorer()
{
	...
	if (H_Exp)
	{
		...
		StartDownloadInternetFile = (tpStartDownloadInternetFile*)GetProcAddress(
			H_Exp, "?StartDownloadInternetFile@@YAXPAD00@Z");
		ProcessDownloadInternetFiles = (tpProcessDownloadInternetFiles*)GetProcAddress(
			H_Exp, "?ProcessDownloadInternetFiles@@YAXXZ");
