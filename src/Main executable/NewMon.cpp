...
char* KeyNames[NKEYS] = {
	...
	"F1", "F2", "F3", "F4", "F5", "F6", "F7", "F8", "F9", "F10", "PGUP", "PGDN", "HOME", "END", "INS", "NUM+", "NUM-",
	"NUM*", "NUM/", "<", ">", "?"
};
...
byte ScanKeys[NKEYS] = {
	...
	VK_F1, VK_F2, VK_F3, VK_F4, VK_F5, VK_F6, VK_F7, VK_F8, VK_F9, VK_F10, VK_NEXT, VK_PRIOR, VK_HOME, VK_END, VK_INSERT,
	107, 109, 106, 111, 188, 190, 191
};
				...
				do
				{
					...
					if (Next)
					{
						...
						else
						{
							...
							else if (!strcmp(DST, "CTRL"))KeyState |= 1;
...
NewAnimation* NewMonster::LoadNewAnimationByName(char* gx)
{
	...
	if (!strcmp(gx, "#MOTION_L"))NANM = &MotionL;
	else if (!strcmp(gx, "#MOTION_R"))NANM = &MotionR;
	else if (!strcmp(gx, "#MOTION_LB"))NANM = &MotionLB;
	else if (!strcmp(gx, "#MOTION_RB"))NANM = &MotionRB;
	else if (!strcmp(gx, "#MINISTEP_L"))NANM = &MiniStepL;
	else if (!strcmp(gx, "#MINISTEP_R"))NANM = &MiniStepL;
	else if (!strcmp(gx, "#MINISTEP_LB"))NANM = &MiniStepL;
	else if (!strcmp(gx, "#MINISTEP_RB"))NANM = &MiniStepL;
	else if (!strcmp(gx, "#ATTACK"))NANM = &Attack[0];
	else if (!strcmp(gx, "#PATTACK"))NANM = &PAttack[0];
	else if (!strcmp(gx, "#UATTACK"))NANM = &UAttack[0];
	else if (!strcmp(gx, "#DEATH"))NANM = &Death;
	else if (!strcmp(gx, "#DEATHLIE1"))NANM = &DeathLie1;
	else if (!strcmp(gx, "#DEATHLIE2"))NANM = &DeathLie2;
	else if (!strcmp(gx, "#DEATHLIE3"))NANM = &DeathLie3;
	else if (!strcmp(gx, "#STAND"))NANM = &Stand;
	else if (!strcmp(gx, "#PSTAND"))NANM = &PStand[0];
	else if (!strcmp(gx, "#WORK"))NANM = &Work;
	else if (!strcmp(gx, "#FIST"))NANM = &Fist;
	else if (!strcmp(gx, "#STANDHI"))NANM = &StandHi;
	else if (!strcmp(gx, "#STANDLO"))NANM = &StandLo;
	else if (!strcmp(gx, "#BUILDHI"))NANM = &BuildHi;
	else if (!strcmp(gx, "#BUILD"))NANM = &Build;
	else if (!strcmp(gx, "#DAMAGE"))NANM = &Damage;
	else if (!strcmp(gx, "#TRANS01"))NANM = &Trans01;
	else if (!strcmp(gx, "#TRANS10"))NANM = &Trans10;
	else if (!strcmp(gx, "#ATTACK1"))NANM = &Attack[1];
	else if (!strcmp(gx, "#PSTAND1"))NANM = &PStand[1];
	else if (!strcmp(gx, "#PATTACK0"))NANM = &PAttack[0];
	else if (!strcmp(gx, "#UATTACK0"))NANM = &UAttack[0];
	else if (!strcmp(gx, "#ATTACK0"))NANM = &Attack[0];
	else if (!strcmp(gx, "#PSTAND0"))NANM = &PStand[0];
	else if (!strcmp(gx, "#MOTION_L0"))NANM = &PMotionL[0];
	else if (!strcmp(gx, "#MOTION_R0"))NANM = &PMotionR[0];
	else if (!strcmp(gx, "#MOTION_LB0"))NANM = &PMotionLB[0];
	else if (!strcmp(gx, "#MOTION_RB0"))NANM = &PMotionRB[0];
	else if (!strcmp(gx, "#MINISTEP_L0"))NANM = &PMiniStepL[0];
	else if (!strcmp(gx, "#MINISTEP_R0"))NANM = &PMiniStepL[0];
	else if (!strcmp(gx, "#MINISTEP_LB0"))NANM = &PMiniStepL[0];
	else if (!strcmp(gx, "#MINISTEP_RB0"))NANM = &PMiniStepL[0];
	else if (!strcmp(gx, "#PATTACK1"))NANM = &PAttack[1];
	else if (!strcmp(gx, "#UATTACK1"))NANM = &UAttack[1];
	else if (!strcmp(gx, "#ATTACK1"))NANM = &Attack[1];
	else if (!strcmp(gx, "#PSTAND1"))NANM = &PStand[1];
	else if (!strcmp(gx, "#MOTION_L1"))NANM = &PMotionL[1];
	else if (!strcmp(gx, "#MOTION_R1"))NANM = &PMotionR[1];
	else if (!strcmp(gx, "#MOTION_LB1"))NANM = &PMotionLB[1];
	else if (!strcmp(gx, "#MOTION_RB1"))NANM = &PMotionRB[1];
	else if (!strcmp(gx, "#MINISTEP_L1"))NANM = &PMiniStepL[1];
	else if (!strcmp(gx, "#MINISTEP_R1"))NANM = &PMiniStepL[1];
	else if (!strcmp(gx, "#MINISTEP_LB1"))NANM = &PMiniStepL[1];
	else if (!strcmp(gx, "#MINISTEP_RB1"))NANM = &PMiniStepL[1];
	else if (!strcmp(gx, "#PATTACK2"))NANM = &PAttack[2];
	else if (!strcmp(gx, "#UATTACK2"))NANM = &UAttack[2];
	else if (!strcmp(gx, "#ATTACK2"))NANM = &Attack[2];
	else if (!strcmp(gx, "#PSTAND2"))NANM = &PStand[2];
	else if (!strcmp(gx, "#MOTION_L2"))NANM = &PMotionL[2];
	else if (!strcmp(gx, "#MOTION_R2"))NANM = &PMotionR[2];
	else if (!strcmp(gx, "#MOTION_LB2"))NANM = &PMotionLB[2];
	else if (!strcmp(gx, "#MOTION_RB2"))NANM = &PMotionRB[2];
	else if (!strcmp(gx, "#MINISTEP_L2"))NANM = &PMiniStepL[2];
	else if (!strcmp(gx, "#MINISTEP_R2"))NANM = &PMiniStepL[2];
	else if (!strcmp(gx, "#MINISTEP_LB2"))NANM = &PMiniStepL[2];
	else if (!strcmp(gx, "#MINISTEP_RB2"))NANM = &PMiniStepL[2];
	else if (!strcmp(gx, "#PATTACK3"))NANM = &PAttack[3];
	else if (!strcmp(gx, "#UATTACK3"))NANM = &UAttack[3];
	else if (!strcmp(gx, "#ATTACK3"))NANM = &Attack[3];
	else if (!strcmp(gx, "#PSTAND3"))NANM = &PStand[3];
	else if (!strcmp(gx, "#MOTION_L3"))NANM = &PMotionL[3];
	else if (!strcmp(gx, "#MOTION_R3"))NANM = &PMotionR[3];
	else if (!strcmp(gx, "#MOTION_LB3"))NANM = &PMotionLB[3];
	else if (!strcmp(gx, "#MOTION_RB3"))NANM = &PMotionRB[3];
	else if (!strcmp(gx, "#MINISTEP_L3"))NANM = &PMiniStepL[1];
	else if (!strcmp(gx, "#MINISTEP_R3"))NANM = &PMiniStepL[1];
	else if (!strcmp(gx, "#MINISTEP_LB3"))NANM = &PMiniStepL[1];
	else if (!strcmp(gx, "#MINISTEP_RB3"))NANM = &PMiniStepL[1];
	else if (!strcmp(gx, "#REST"))NANM = &Rest;
	else if (!strcmp(gx, "#REST1"))NANM = &Rest1;
	else if (!strcmp(gx, "#ROTATE_R"))NANM = &RotateR;
	else if (!strcmp(gx, "#ROTATE_L"))NANM = &RotateL;
	else if (!strcmp(gx, "#WORKTREE"))NANM = &WorkTree;
	else if (!strcmp(gx, "#WORKSTONE"))NANM = &WorkStone;
	else if (!strcmp(gx, "#WORKFIELD"))NANM = &WorkField;
	else if (!strcmp(gx, "#BUILDLO_0"))NANM = &PMotionL[0];
	else if (!strcmp(gx, "#BUILDLO_1"))NANM = &PMotionL[1];
	else if (!strcmp(gx, "#BUILDLO_2"))NANM = &PMotionL[2];
	else if (!strcmp(gx, "#BUILDLO_3"))NANM = &PMotionL[3];
	else if (!strcmp(gx, "#BUILDHI_0"))NANM = &PMotionR[0];
	else if (!strcmp(gx, "#BUILDHI_1"))NANM = &PMotionR[1];
	else if (!strcmp(gx, "#BUILDHI_2"))NANM = &PMotionR[2];
	else if (!strcmp(gx, "#BUILDHI_3"))NANM = &PMotionR[3];
	else if (!strcmp(gx, "#HIANIMATION"))NANM = &Work;
	else if (!strcmp(gx, "#TRANSX3"))NANM = &TransX3;
	else
...
{
	if (!strcmp(str, "BODY"))return 1;
	else if (!strcmp(str, "STONE"))return 2;
	else if (!strcmp(str, "WOOD"))return 4;
	else if (!strcmp(str, "IRON"))return 8;
	else if (!strcmp(str, "FLY"))return 16;
	else if (!strcmp(str, "BUILDING"))return 32;
	else if (!strcmp(str, "WOOD_BUILDING"))return 64;
	else
			...
			if (gx[0] != '/' && gx[0] != '[')
			{
				...
				else
				{
					...
					else
					{
						...
						else if (!strcmp(gx, "ARCHER"))
						{
							Archer = 1;
							Line++;
							NLine(f1);
						}
						else if (!strcmp(gx, "FORCE"))
						{
							z = Gscanf(f1, "%d", &p1);
						...
						else if (!strcmp(gx, "FORWARD"))
						{
							ShotForward = true;
							NLine(f1);
							Line++;
						}
						else if (!strcmp(gx, "OFFICER"))
						{
							Officer = true;
							NLine(f1);
							Line++;
						}
						else if (!strcmp(gx, "BARABAN"))
						{
							Baraban = true;
							NLine(f1);
							Line++;
						}
						else if (!strcmp(gx, "NO_HUNGRY"))
						{
							NotHungry = true;
							NLine(f1);
							Line++;
						}
						else if (!strcmp(gx, "MFARM"))
						{
							z = Gscanf(f1, "%d", &p1);
							if (z != 1)IncPar(name, Line, gx);
							NInFarm = p1;
							...
							if (!strcmp(gx, "USAGE"))
							{
								...
								else
								{
									...
									else
									{
										...
										{
											if (!strcmp(gy, TowerIDS))Usage = TowerID;
											else if (!strcmp(gy, CenterIDS))Usage = CenterID;
											else if (!strcmp(gy, MineIDS))Usage = MineID;
											else if (!strcmp(gy, FieldIDS))Usage = FieldID;
											else if (!strcmp(gy, PeasantIDS))Usage = PeasantID;
											else if (!strcmp(gy, FastHorseIDS))Usage = FastHorseID;
											else
											{
												...
												else if (!strcmp(gy, PushkaIDS))
												{
													Usage = PushkaID;
													Artilery = true;
													//AttBuild=true;
												}
												else if (!strcmp(gy, MultiCannonIDS))
												{
													Usage = MultiCannonID;
													Artilery = true;
													//AttBuild=true;
												...
												{
													if (!strcmp(gy, GrenaderIDS))Usage = GrenaderID;
													else if (!strcmp(gy, HardWallIDS))Usage = HardWallID;
													else if (!strcmp(gy, WeakWallIDS))Usage = WeakWallID;
													else if (!strcmp(gy, LinkorIDS))Usage = LinkorID;
													else if (!strcmp(gy, WeakIDS))Usage = WeakID;
													else if (!strcmp(gy, FisherIDS))Usage = FisherID;
													else if (!strcmp(gy, ArtDepoIDS))Usage = ArtDepoID;
													else if (!strcmp(gy, SupMortIDS))
													{
														Usage = SupMortID;
														Artilery = true;
														//AttBuild=true;
													...
													{
														if (!strcmp(gy, PortIDS))Usage = PortID;
														else if (!strcmp(gy, LightInfIDS))Usage = LightInfID;
														else if (!strcmp(gy, StrelokIDS))Usage = StrelokID;
														else if (!strcmp(gy, HardHorceIDS))Usage = HardHorceID;
														else if (!strcmp(gy, HorseStrelokIDS))Usage = HorseStrelokID;
														else if (!strcmp(gy, FregatIDS))Usage = FregatID;
														else if (!strcmp(gy, GaleraIDS))Usage = GaleraID;
														else if (!strcmp(gy, IaxtaIDS))Usage = IaxtaID;
														else if (!strcmp(gy, ShebekaIDS))Usage = ShebekaID;
														else if (!strcmp(gy, ParomIDS))Usage = ParomID;
														else if (!strcmp(gy, ArcherIDS))Usage = ArcherID;
						...
						if (Line0 == Line)
							...
							else if (!strcmp(gx, "NAEMNIK"))
							{
								Behavior = 2;
								NLine(f1);
								Line++;
							}
							else if (!strcmp(gx, "TURNOFF"))
							{
								Behavior = 1;
								NLine(f1);
								Line++;
							...
							else if (!strcmp(gx, "SHOWDELAY"))
							{
								ShowDelay = true;
								NLine(f1);
								Line++;
							}
							else if (!strcmp(gx, "ARTPODGOTOVKA"))
							{
								Artpodgotovka = 1;
								NLine(f1);
								Line++;
							}
							else if (!strcmp(gx, "NOFULLDESTRUCT"))
							{
								NoDestruct = 1;
								NLine(f1);
								Line++;
							}
							else if (!strcmp(gx, "CAPTURE"))
							{
								Capture = true;
								NLine(f1);
								Line++;
							}
							else if (!strcmp(gx, "RASTRATA_NA_VISTREL"))
							{
							...
							else if (!strcmp(gx, "RASTRATA_NA_VISTREL2"))
							{
							...
							else if (!strcmp(gx, "RESOURCEBASE"))
							{
								z = Gscanf(f1, "%d", &p1);
								...
								for (int i = 0; i < p1; i++)
								{
									...
									else if (!strcmp(gy, "GOLD"))
									{
										ms |= 2;
									}
									else if (!strcmp(gy, "STONE"))
									{
										ms |= 4;
									}
									else if (!strcmp(gy, "FOOD"))
									{
										ms |= 8;
									}
									else
							...
							else if (!strcmp(gx, "WATERROUND"))
							{
								WaterActive = true;
								NLine(f1);
								Line++;
							}
							else if (!strcmp(gx, "SPRITES"))
							{
							...
							else if (!strcmp(gx, "STAGELOCKPOINTS"))
							{
							...
							else if (!strcmp(gx, "BUILDLOCKPOINTS"))
							{
								z = Gscanf(f1, "%d", &p1);
								if (z != 1)IncPar(name, Line, gx);
								NBLockPt = p1;
							...
							else if (!strcmp(gx, "CONCENTRATOR"))
							{
								z = Gscanf(f1, "%d", &p1);
							...
							else if (!strcmp(gx, "SLOWRECHARGE"))
							{
								SlowRecharge = 1;
								NLine(f1);
								Line++;
							}
							else if (!strcmp(gx, "NOPAUSEDATTACK"))
							{
								z = Gscanf(f1, "%d", &p2);
								if (z != 1)IncPar(name, Line, gx);
								NoWaitMask |= 1 << p2;
							...
							else if (!strcmp(gx, "CANBEKILLEDINSIDE"))
							{
								CanBeKilledInside = 1;
								NLine(f1);
								Line++;
							}
							else if (!strcmp(gx, "CANBECAPTUREDWHENFREE"))
							{
								CanBeCapturedWhenFree = 1;
								NLine(f1);
								Line++;
							}
							else if (!strcmp(gx, "CANSHOOT"))
							{
								CanShoot = 1;
								NLine(f1);
								Line++;
							}
							else if (!strcmp(gx, "CANSTORM"))
							{
								CanStorm = 1;
								NLine(f1);
								Line++;
							}
							else if (!strcmp(gx, "PROMAX"))
							{
								z = Gscanf(f1, "%d", &p1);
								if (z != 1)IncPar(name, Line, gx);
								PromaxPercent = p1;
							...
							else if (!strcmp(gx, "ADDSHOTRADIUS"))
							{
								z = Gscanf(f1, "%d", &p1);
								if (z != 1)IncPar(name, Line, gx);
								AddShotRadius = p1;
							...
							else if (!strcmp(gx, "COST"))
							{
								NLine(f1);
								Line++;
							}
							else if (!strcmp(gx, "PRICE"))
							{
								z = Gscanf(f1, "%d", &p1);
							...
							else if (!strcmp(gx, "SEARCH_ENEMY_RADIUS"))
							{
								z = Gscanf(f1, "%d", &p1);
								if (z != 1)IncPar(name, Line, gx);
								VisRange = p1 << 4;
							...
							else if (!strcmp(gx, "SETACTIVEPOINT"))
							{
							...
							else if (!strcmp(gx, "ATTACK_RADIUS"))
							{
								z = Gscanf(f1, "%d%d%d", &p1, &p2, &p3);
								if (z != 3)IncPar(name, Line, gx);
								if (p1 >= NAttTypes)
							...
							else if (!strcmp(gx, "ADD_ATTACK_RADIUS"))
							{
								z = Gscanf(f1, "%d%d", &p1, &p2);
							...
							else if (!strcmp(gx, "ATTACK_PAUSE"))
							{
								z = Gscanf(f1, "%d%d", &p1, &p2);
							...
							else if (!strcmp(gx, "ATTACK_ANGLES"))
							{
								z = Gscanf(f1, "%d%d%d", &p1, &p2, &p3);
							...
							else if (!strcmp(gx, "SPRITEOBJECT"))
							{
								SpriteObject = true;
								Building = true;
								NLine(f1);
							...
							else if (!strcmp(gx, "PRODUCER"))
							{
								...
								for (int i = 0; i < p1; i++)
								{
									z = Gscanf(f1, "%s", gy);
									if (z != 1)IncPar(name, Line, gx);
									if (!strcmp(gy, "WOOD"))ProdType |= 1;
									else if (!strcmp(gy, "GOLD"))ProdType |= 2;
									else if (!strcmp(gy, "STONE"))ProdType |= 4;
									else if (!strcmp(gy, "FOOD"))ProdType |= 8;
									else if (!strcmp(gy, "IRON"))ProdType |= 16;
									else if (!strcmp(gy, "COAL"))ProdType |= 32;
									else
									{
										sprintf(gz, "%s,Line %d : %s : Unknown resource type : %s.\n Must be one of WOOD,STONE,GOLD,FOOD,IRON,COAL.",
										        name, Line, gx, gy);
										ErrM(gz);
									};
								};
							...
							else if (!strcmp(gx, "PEASANT"))
							{
								Peasant = true;
								NLine(f1);
								Line++;
							}
							else if (!strcmp(gx, "UNITABSORBER"))
							{
								z = Gscanf(f1, "%d", &p1);
							...
							else if (!strcmp(gx, "PEASANTABSORBER"))
							{
								z = Gscanf(f1, "%d", &p1);
	...
	if (f1)
	{
		...
		do
		{
			...
			if (gx[0] == '[')
			{
				...
				else if (!strcmp(gx, "[FIRETRANSFORM]"))mode = 2;
				else if (!strcmp(gx, "[SOURCES]"))mode = 3;
				else if (!strcmp(gx, "[TIMETRANSFORM]"))mode = 4;
				else if (!strcmp(gx, "[INTERNAL_SOURCE]"))mode = 5;
				else if (!strcmp(gx, "[DISCRET]"))mode = 6;
				else if (!strcmp(gx, "[LOCK]"))mode = 7;
				else if (!strcmp(gx, "[END]"))mode = 255;
				else
				{
...
word GetDir(int dx, int dy)
{
	...
	if (dx != 0 || dy != 0)
	{
		int adx = abs(dx);
		int ady = abs(dy);
		if (adx > ady)PhDir = byte(TAtg[div( ady << 8, adx ).quot]);
		else
...
#endif
void QShowFires(OneObject* OB, int x0, int y0, int FirIDX, NewAnimation** PreFires, NewAnimation** FiresAnm,
                int NFiresAnm, int FIndex)
{
	if (!NFiresAnm)return;
#ifdef CONQUEST
	if ( OB->StageState )
				...
				if (xx > -128 && zz > -128 && xx < Lx1 + 128 && zz < Ly1 + 128)
				{
					...
					if (NAM && NAM->Enabled && csp < NAM->NFrames)
					{
						...
						if (!octs)
						{
							...
							AddPoint(xx, yy, (xx + NF->dx) >> (5 - Shifter), ((zz + NF->dy) >> (5 - Shifter)), OB, NF->FileID, NF->SpriteID,
							         0, 0);
						}
						else
						{
							...
							else
							{
								if (dir < ocM)
								{
									if (Downpart)
									{
										AddLoPoint((xx - NF->dx) >> (5 - Shifter), ((zz + NF->dy) >> (5 - Shifter)), OB, NF->FileID,
										           oc2 - dir + NAM->Rotations * NF->SpriteID + 4096, 0, 0);
										if (UpAnm)
										{
											AddPoint(xx, yy + NM->UpperPartShift, (xx - UNF->dx) >> (5 - Shifter), ((zz + UNF->dy) >> (5 - Shifter)), OB,
											         UNF->FileID, oc2 - dir + NAM->Rotations * UNF->SpriteID + 4096, 0, 0);
										}
									}
									else
									{
										if (NM->LinearLength)
										{
											...
											AddLine(xx - dx, yy - dy, xx + dx, yy + dy, (xx - NF->dx) >> (5 - Shifter), ((zz + NF->dy) >> (5 - Shifter)),
											        OB, NF->FileID, oc2 - dir + NAM->Rotations * NF->SpriteID + 4096, 0, 0);
										}
										else
										{
											AddPoint(xx, yy, (xx - NF->dx) >> (5 - Shifter), ((zz + NF->dy) >> (5 - Shifter)), OB, NF->FileID,
											         oc2 - dir + NAM->Rotations * NF->SpriteID + 4096, 0, 0);
										}
									}
								}
								else
								{
									...
									{
										AddLoPoint((xx + NF->dx) >> (5 - Shifter), ((zz + NF->dy) >> (5 - Shifter)), OB, NF->FileID,
										           oc2 - dir + NAM->Rotations * NF->SpriteID, 0, 0);
										if (UpAnm)
										{
											AddPoint(xx, yy + NM->UpperPartShift, (xx + UNF->dx) >> (5 - Shifter), ((zz + UNF->dy) >> (5 - Shifter)), OB,
											         UNF->FileID, oc2 - dir + NAM->Rotations * UNF->SpriteID, 0, 0);
										}
									}
									else
									{
										if (NM->LinearLength)
										{
											...
											int dy = (LL * TSin[OB->RealDir]) >> 9;
											AddLine(xx - dx, yy - dy, xx + dx, yy + dy, (xx + NF->dx) >> (5 - Shifter), ((zz + NF->dy) >> (5 - Shifter)),
											        OB, NF->FileID, oc2 - dir + NAM->Rotations * NF->SpriteID, 0, 0);
										}
										else
										{
											AddPoint(xx, yy, (xx + NF->dx) >> (5 - Shifter), ((zz + NF->dy) >> (5 - Shifter)), OB, NF->FileID,
								...
								if (NM->FLAGS && !OB->Sdoxlo)
								{
									...
									for (int i = 0; i < N; i++)
									{
										...
										AddPoint(xx + dx1, yy + dy1 + pt[i3 + 3], xx + dx1 - 48, yy + dy1 - dz - 28, OB, 2, (tmtmt + 19 * i) % 52, 0,
										         0);
									}
								}
								...
								if (NM->Reflection)
								{
									...
									if (NAM && NAM->Rotations != 1)
									{
										...
										if (Rdir < RocM)
										{
											AddOptPoint(ZBF_LO, 0, 0, (xx - NF->dx) >> (5 - Shifter), ((zz + NF->dy) >> (5 - Shifter)), OB, NF->FileID,
											            Roc2 - Rdir + NAM->Rotations * NF->SpriteID + 4096, 256 + 512);
										}
										else
										{
											Rdir = Roc1 - Rdir;
											AddOptPoint(ZBF_LO, 0, 0, (xx + NF->dx) >> (5 - Shifter), ((zz + NF->dy) >> (5 - Shifter)), OB, NF->FileID,
											            Roc2 - Rdir + NAM->Rotations * NF->SpriteID, 256 + 512);
										}
									}
								}
							}
					...
					if (NM)
					{
						...
						if (xx1 > 0 && xx0 <= Lx1 && yy1 > 0 && yy0 < Ly1)
						{
							...
							if (ANM && ANM->Enabled)
							{
								...
								{
									NewFrame* NF = &ANM->Frames[i + CSP];
									AddPoint(xre + NF->dx, yre + NM->AnmUpShift + NF->dy, xs + NF->dx, ys + NF->dy, OB, NF->FileID, NF->SpriteID,
									         0, 0);
									xs += ANM->PartSize;
								}
...
void CalculateMotionX0()
{
	...
	for (int i = 0; i < MAXOBJECT; i++)
	{
		...
		if (OB)
		{
			...
			else if (OB->NewMonst/*&&OB->NewCurSprite==OB->NewAnm->NFrames-1*/)
			{
				...
				if (!(dx >= (olx + Lx) || dy >= (olx + Lx)))
				{
					...
					else
					{
						if (MyObj->LocalOrder && MyObj->LocalOrder->DoLink == &AttackObjLink &&
							MyObj->LocalOrder->info.MoveToObj.ObjIndex == OB->Index)
							return true;
...
int CheckCreationAbility(byte NI, NewMonster* NM, int* x2i, int* y2i, word* BLD, int NBLD)
{
	...
	if (NM->Building)
	{
		...
		if (!CheckBuildingsInArea(x + (NM->BuildX0 << 4), y + (NM->BuildY0 << 4), x + (NM->BuildX1 << 4),
		                          y + (NM->BuildY1 << 4), BLD, NBLD))return -1;
...
word GoodSelectNewMonsters(byte NI, int xr, int yr, int xr1, int yr1, word* Collect, word* Ser, bool WRITE, CHOBJ* FN,
                           int NN, int MAX)
{
	...
	if (abs(xr - xr1) < 5 && abs(yr - yr1) < 5)
	{
		...
		if (IDX != 0xFFFF)
		{
			...
			if (OB && OB->newMons && (!((OB->ImSelected & GM( NI )) || OB->Hidden || OB->Sdoxlo || OB->UnlimitedMotion)) && OB->
				NNUM == NIX && ((!FN) || FN(OB, NN)))
			{
				if (WRITE)
				{
...
void BuildObjLink(OneObject* OBJ)
{
	...
	{
		if (OB && OB->NNUM == MyNation && OB->Life == OB->MaxLife)AddUnlimitedEffect(
			OB->RealX >> 4, (OB->RealY >> 5) - OB->RZ, OB->newMons->BornSoundID);
		if (OBJ->LocalOrder)
		{
			OBJ->DeleteLastOrder();
			OBJ->DeletePath();
...
bool CheckPlaceForShar(int x, int y)
{
	...
	int h = GetHeight(x, y);
	if (abs(GetHeight(x - 60, y) - h) > 10 || abs(GetHeight(x + 60, y) - h) > 10 || abs(GetHeight(x, y - 60) - h) > 10 ||
		abs(GetHeight(x, y + 60) - h) > 10)return false;
	//check monsters
